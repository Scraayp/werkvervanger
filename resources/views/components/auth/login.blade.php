        ...
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                    Log tot je account in!
                </h1>
                <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Je
                            email</label>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('auth.forget-password') }}"
                            class="text-sm font-medium text-blue-700 hover:underline dark:text-blue-500">Forgot
                            password?</a>
                    </div>
                    <button type="submit"
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Don’t have an account yet? <a href="{{ route('auth.register') }}"
                            class="font-medium text-blue-600 dark:text-blue-400 dark:hover:text-blue-600">Sign
                            up</a>
                    </p>
                </form>
            </div>
