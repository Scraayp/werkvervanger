<section
    class="bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')] mt-20">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
        <a href="#"
            ...
            <span class="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 me-3">Alpha</span> <span
                class="text-sm font-medium">Wekvervanger gelanceerd in alpha modus!</span>
        ...
        <h1
            ...
            Werkvervanger (alpha) launch.</h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">Werkvervanger
            geeft een mogelijkheid voor werknemers onderling vervanging te regelen zonder gebruik te maken van Whatsapp
            etc..
        </p>
